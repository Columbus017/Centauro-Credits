...
import { COLLECTOR_SORT_KEYS, listCollectors } from '@/lib/queries/entities'
import { requireAdmin } from '@/lib/session'

export default async function CollectorsPage({ params, searchParams }: PageProps<'/[locale]'>) {
  ...
  const sort = parseSort(firstParam(query.sort), firstParam(query.dir), COLLECTOR_SORT_KEYS)

  const rows = await listCollectors(sort)
