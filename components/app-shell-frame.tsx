...
/**
 * The chrome. Rendered by the `AppShell` server component in
 * `components/app-shell.tsx`, which is where `role` and `userName` come from —
 * they are session facts, and a client component cannot read the session.
 */
